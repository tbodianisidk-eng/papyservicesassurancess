...
const adminNavItems: NavItem[] = [
  ...
  { label: "Statistiques",   icon: <BarChart2 size={18} />,       path: "/statistiques" },
  {
    label: "Production",
    icon: <Shield size={18} />,
    children: [
  ...
  { label: "Assurés",        icon: <Users size={18} />,       path: "/assures" },
  { label: "Utilisateurs",   icon: <UserCog size={18} />,     path: "/users" },
  { label: "Prestataires",   icon: <Stethoscope size={18} />, path: "/prestataires" },
  {
    label: "Sinistres",
  ...
  { label: "Archives",       icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600"><rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"/><path d="M10 12h4"/></svg>, path: "/archives" },
];
